...
export const ROUTES = {
  ...
  '/karera':     { prog: 0.62, yaw: 0,  Comp: CareersPage, title: 'Карьера · Центр цифрового развития', desc: 'Разрабатывай ИТ-решения национального масштаба: вакансии, стек, стажировки.', light: { top: '#daf2ff', a: '#aed6ef', b: '#f1fbff' }, dark: { top: '#10325c', a: '#070f20', b: '#04070f' } },
