...
export const ROUTES = {
  ...
  '/uslugi':   { prog: 0.62, yaw: 0,  Comp: ServicesPage, title: 'Услуги · Центр цифрового развития', desc: 'Разработка цифровых продуктов, low-code платформы, интеграции и IT-консалтинг.', light: { top: '#d6f7ec', a: '#aee6d3', b: '#f0fdf8' }, dark: { top: '#0c3a44', a: '#06120f', b: '#04080a' } },
  '/proekty':  { prog: 0.62, yaw: 0,  Comp: ProjectsPage, title: 'Проекты и инновации · Центр цифрового развития', desc: 'Ключевые технологические проекты ЦЦР: Фабрика данных, NBK AI Platform, портал госзакупок НБК, регуляторная песочница.', light: { top: '#d4f6ff', a: '#a9def0', b: '#f0fbff' }, dark: { top: '#0c2c44', a: '#06121f', b: '#04080f' } },
  '/karera':     { prog: 0.40, yaw: 0,  Comp: CareersPage, title: 'Карьера · Центр цифрового развития', desc: 'Разрабатывай ИТ-решения национального масштаба: вакансии, стек, стажировки.', light: { top: '#daf2ff', a: '#aed6ef', b: '#f1fbff' }, dark: { top: '#10325c', a: '#070f20', b: '#04070f' } },
  '/partners':   { prog: 0.62, yaw: 0, Comp: PartnersPage, title: 'Партнёрам · Центр цифрового развития', desc: 'Экспресс-комплаенс и подача документов для ИТ-подрядчиков.', light: { top: '#dde9ff', a: '#aec7ec', b: '#f3f7ff' }, dark: { top: '#102a52', a: '#070f20', b: '#04070f' } },
